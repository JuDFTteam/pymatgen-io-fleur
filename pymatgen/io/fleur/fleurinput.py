...
class FleurInput(MSONable):
    ...
    def __init__(self, structure: Structure, title: str=None, pbc: Tuple[bool,bool,bool]=(True,True,True), lapw_parameters: dict=None):
        """
        Args:
    ...
    def from_string(data: str, inpgen_input:bool=True, **kwargs) -> "FleurInput":
        ...
        if inpgen_input:
            ...
            title_in = evaluate_text(xmltree, schema_dict, 'comment')
    ...
    def from_file(filename: PathLike) -> "FleurInput":
        ...
        inpgen_input = not filename.endswith('.xml')
    ...
    def get_inpgen_file_content(self, parameters:dict=None, ignore_set_parameters:bool=False, **kwargs: Union[int,bool]):
        ...
        return write_inpgen_file(self.structure.lattice.matrix, atom_sites, return_contents=True, input_params=parameters, convert_from_angstroem=False,**kwargs)
    ...
    def write_file(self, filename: PathLike, **kwargs: Union[dict,int,str]):
        """
